...
VALUES('3030','外呼任务管理','2000','18','/aicall/callTask','menuItem','C','0','1','aicall:callTask:view','#','admin',NOW()) ;
...
-- AI外呼记录查询菜单
INSERT INTO `sys_menu` (`menu_id`,`menu_name`,`parent_id`,`order_num`,`url`,`target`,`menu_type`,`visible`,`is_refresh`,`perms`,`icon`,`create_by`,`create_time`)
VALUES('3040','AI外呼记录','2000','19','/aicall/callPhone','menuItem','C','0','1','aicall:callPhone:view','#','admin',NOW()) ;
